package com.ihridoydas.simpleapp.util.responsiveUI.component.casecade.menuTabRow
...
fun MenuTabView() {
   ...
   //Animating Item (Looping item) one by one (Not need implement in real Environment)
...
//useCase Tab Menu in Row
@Preview(showBackground = true)
@Composable
fun MenuTabViewPreview() {
    SimpleAppTheme {
        MenuTabView()
    }
}